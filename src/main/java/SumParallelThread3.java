...
public class SumParallelThread3 extends Thread {
	...
	public SumParallelThread3(String name, int indexStart, int indexFinish) {
...
//						".\nRuntime of thread " + this.threadName + " is " + runTime + " nanoSeconds.\n");
				...
				Main.spts3.setThreadName(threadName);
				Main.spts3.setThreadSum(threadSum);
				Main.spts3.setThreadTime(threadTime);
			}
		}
