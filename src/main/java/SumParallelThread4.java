...
public class SumParallelThread4 extends Thread {
	...
	public SumParallelThread4(String name, int indexStart, int indexFinish) {
...
//						".\nRuntime of thread " + this.threadName + " is " + runTime + " nanoSeconds.\n");
				...
				Main.spts4.setThreadName(threadName);
				Main.spts4.setThreadSum(threadSum);
				Main.spts4.setThreadTime(threadTime);
			}
		}
